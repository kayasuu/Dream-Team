...
<li class="nav-item navbar-text" onClIck="renderBucketList(email)">Bucket List |</li>
<li class="nav-item navbar-text" onClick="addBucketListForm(email)">Add Bucket List Item |</li>

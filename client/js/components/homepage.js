function renderHomePage() {
    ...
    page.innerHTML = `
        <div class="container text-center py-5">
            <h2 class="pb-3">Welcome to BucketList.AI</h2>
            <p class="lead pb-5">
            ...
            <div class="d-flex justify-content-center">
                <img class="mx-auto img-fluid pt-3" src="https://i.ibb.co/d4Px2MB/bucket-list-AI-pic.png" alt="person sits on a big silver bucket slightly hunched over looking at a book, positioned on a cliff looking over at a lake and some mountains"></img>
            </div>
        </div>
    `;
}